...
import Content from '../components/ContentNotLoggedFilteredEntry/Content'
import ReadProductsComponent from '../components/ContentNotLoggedFilteredEntry/ReadProductsComponent'
'use strict';
...
ReactDOM.render(
    <Router history={browserHistory}>
        <Route path="/content_filtered.php" component={Content}>
