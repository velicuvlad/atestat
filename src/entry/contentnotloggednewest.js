...
import Content from '../components/ContentNotLoggedNewestEntry/Content'
import ReadProductsComponent from '../components/ContentNotLoggedNewestEntry/ReadProductsComponent'
'use strict';
...
ReactDOM.render(
    <Router history={browserHistory}>
        <Route path="/content_newest.php" component={Content}>
