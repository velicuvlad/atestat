...
<head>
    ...
    <title>Personal Blog | All articles</title>
    ...
    <div>
        ...
        <script type="text/javascript" src="/build/contentnewest.js"></script>
    ...
    <?php else : ?>
        ...
        <script type="text/javascript" src="/build/contentnotloggednewest.js"></script>
        <script src="libs/js/jquery.js"></script>
        <script src="libs/css/bootstrap/js/bootstrap.min.js"></script>
